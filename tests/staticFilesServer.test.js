...
describe('Static files server', () => {
  describe('createServer', () => {
    ...
    describe('Server', () => {
      let server;
      const publikFolderPath = path.resolve(__dirname, '../public');
      ...
      beforeEach(() => {
        ...
        if (!fs.existsSync(publikFolderPath)) {
          fs.mkdirSync(publikFolderPath);
        }
      ...
      afterEach(() => {
        ...
        if (fs.existsSync(publikFolderPath)) {
          fs.rmdirSync(publikFolderPath, { recursive: true });
        }
      ...
      describe('Root path requests', () => {
        it('should return hint message for /file', async() => {
      ...
      describe('Attempt to access files outside public folder', () => {
        ...
        it('should return 404 for paths with additional slashes', async() => {
          try {
      ...
      describe('Other routes', () => {
        it('should return hint message for routes not starting with /file/', async() => {
          const response = await axios.get(`${HOST}/other`);
